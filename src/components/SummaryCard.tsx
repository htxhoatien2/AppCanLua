...
export const SummaryCard: React.FC<SummaryCardProps> = ({
  ...
  return (
    <div className={`p-5 sm:p-7 rounded-3xl border shadow-2xl transition-all duration-300 relative overflow-hidden ${
      darkMode
        ? 'bg-gradient-to-br from-slate-900 via-slate-850 to-amber-950/60 border-amber-500/40 shadow-black/80'
        : 'bg-gradient-to-br from-amber-600 via-amber-700 to-amber-800 text-white border-amber-900 shadow-amber-900/30'
    }`}>
      {/* Glow Accent Circle */}
      <div className="absolute -bottom-16 -left-16 w-40 h-40 bg-amber-400/20 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="flex justify-between items-center mb-4 pb-3 border-b border-white/20">
        ...
        <div className="text-xs bg-black/30 backdrop-blur-md text-amber-200 px-3.5 py-1 rounded-full border border-white/20 font-bold shadow-inner">
      ...
      <div className="bg-slate-950/50 backdrop-blur-lg p-5 rounded-3xl border border-white/20 mb-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-5 shadow-2xl">
        {/* Net Weight */}
        <div>
          <div className="text-xs text-amber-300 uppercase tracking-widest font-extrabold flex items-center gap-1.5">
          ...
          <div className="text-xs text-amber-100/90 mt-1 font-semibold">
        ...
        <div className="w-full md:w-auto text-left md:text-right border-t md:border-t-0 border-white/20 pt-4 md:pt-0">
          <div className="text-xs text-amber-300 uppercase tracking-widest font-extrabold flex items-center gap-1.5 md:justify-end">
          ...
          {totals.depositAmount > 0 && (
            <div className="text-xs text-amber-200 mt-1 font-bold bg-amber-950/70 px-3 py-1 rounded-xl border border-amber-500/40 inline-block shadow-sm">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5 pt-1">
        <button
          ...
          className="bg-white text-slate-950 hover:bg-amber-100 active:scale-95 font-lexend font-black py-3.5 px-3 rounded-2xl shadow-xl text-xs sm:text-sm flex items-center justify-center gap-1.5 transition-all border border-white"
        >
